...
use crate::panels::command_palette::state::CommandInfo;
...
script_mod! {
    ...
    mod.components.ThreadlaneCommandTextInputBase = #(ThreadlaneCommandTextInput::register_widget(vm))

    mod.components.ThreadlaneCommandTextInput = mod.components.ThreadlaneCommandTextInputBase{
        flow: Down
        height: Fit
...
pub struct ThreadlaneCommandTextInput {
    #[source]
...
impl Widget for ThreadlaneCommandTextInput {
...
impl ThreadlaneCommandTextInput {
